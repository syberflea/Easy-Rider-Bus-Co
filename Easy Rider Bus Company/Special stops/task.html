...
<pre><code class="language-no-highlight">There is no start or end stop for the line: 512.</code></pre>
...
<pre><code class="language-no-highlight">Start stops: 3 ['Bourbon Street', 'Pilotow Street', 'Prospekt Avenue']
Transfer stops: 3 ['Elm Street', 'Sesame Street', 'Sunset Boulevard']
Finish stops: 2 ['Sesame Street', 'Sunset Boulevard']</code></pre>