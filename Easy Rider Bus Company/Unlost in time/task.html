...
<ol>
	...
	<li>If all the lines are correct timewise, print <code class="language-json">OK</code>.</li>
...
<pre><code class="language-no-highlight">Arrival time test:
bus_id line 128: wrong time on station Fifth Avenue
bus_id line 256: wrong time on station Sunset Boulevard</code></pre>
